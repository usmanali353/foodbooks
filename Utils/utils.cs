...
namespace foodbooks.Utils
{
    public class utils
    {
        ...
        public double CalculateDistance(double businessLatitude,double businessLongitude,double userLatitude,double userlongitude)
        {
            var d1 = businessLatitude * (Math.PI / 180.0);
            var num1 = businessLongitude * (Math.PI / 180.0);
